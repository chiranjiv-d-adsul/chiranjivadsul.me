  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        experience:
          " url('/src/assets/backgrounds/white-abstract.png')",
          experienceLight:
          'linear-gradient(137deg, rgba(244,244,246,0.5) 60%, rgba(10,10,10,0.9) 60%)',
        experienceLight2:
          'linear-gradient(1644deg, rgba(244,244,246,0.5) 60%, rgba(10,10,10,0.9) 60%)',
        ...
        tech: "linear-gradient(165deg, rgba(20,20,20,0.8) 100%, rgba(109,109,116,0.8) 100%), url('/src/assets/backgrounds/tech.jpg')",
