...
const projects = [
  {
    ...
    description:
      "An advanced AI-powered content generation tool, designed to streamline and expedite the process of creating written content. Utilizes machine learning models to generate diverse and relevant content based on user-provided prompts.",
    detailed:
  ...
  {
    id: "chatter",
    name: "Chatter (Real-time Chat Application)",
    description:
      "Real-time chat application for interactive messaging between users. Users can exchange messages instantly with real-time updates.",
    tags: [
    ...
    image: chatter,
    repo: "https://github.com/chiranjiv-d-adsul/Chatter-Socket.Io.git",
...

  {
    ...
    description:
      "Efficiently manage and track tasks with dynamic features for creating, updating, and organizing to-do items. Includes functionalities for real-time task management across different stages.",
    detailed:
      "The Dynamic To-Do List Application is designed to streamline task management by providing dynamic features for creating, updating, and organizing tasks. The application allows users to add new tasks to the Pending section, move tasks between Pending, In Progress, and Completed sections, and displays a timestamp for completed tasks. The optional drag-and-drop functionality enhances user experience by simplifying task movement between sections. The project involves setting up the environment, developing both the backend and frontend, and implementing real-time task management functionalities.",
    tags: [
      {
        name: "react.js",
        color: "blue-text-gradient",
...

  {
    ...
    description:
      "Manage user lists, upload users via CSV, and send personalized emails efficiently. Features include creating user lists, importing users, and sending emails through an intuitive frontend interface.",
    detailed:
      "The User List Management application allows for efficient management of user lists, with capabilities to upload users via CSV and send personalized emails. The process setup includes installing dependencies and configuring the environment. The backend is powered by an Express server with MongoDB, while the frontend is built with React and launched using Vite. Users can create and customize user lists, import users from CSV files, and send personalized emails to list members. This tool streamlines the process of managing user data and communication.",
    tags: [
      {
        name: "react.js",
        color: "blue-text-gradient",
...

  {
    ...
    detailed:
      " the dummy healthcare system, patients can easily navigate through the platform to explore various departments and services offered by the hospital. Upon registration and login, patients gain access to a comprehensive overview of available medical services.",
    tags: [
      {
        name: "php",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    name: "SocialPilot",
    description:
      "Developing a multi-platform recruitment tool for recruiters to simultaneously post job openings across various platforms. Features integration with platforms like Facebook, LinkedIn, Medium, etc.",
    detailed:
      "SocialPilot is a multi-platform recruitment tool designed to streamline the process of posting job openings across various platforms simultaneously. It utilizes React for dynamic user interfaces, Node.js for server-side logic, Express.js for backend routing, and Tailwind CSS for efficient styling. Upon signing in, users are redirected to the homepage and can access the dashboard by clicking on the signin button. The project aims to enhance recruiter productivity by providing a unified platform for managing job postings across multiple channels.",
    tags: [
      {
        name: "react.js",
        color: "blue-text-gradient",
